...
if __name__ == '__main__':
    ...
    duncan_test = DuncanTest([data1, data2, data3, data4, data5])
    duncan_test.datacontroller()
    hypotheses = duncan_test.formHyp()
    distribution = duncan_test.distribution()
    test_value = duncan_test.testval()
    conclusion = duncan_test.conclusion()

    print("Formulation des hypothèses:\n", hypotheses)
    print("Distribution utilisée:\n", distribution)
    print("Valeur du test:\n", test_value)
    print("Conclusion:\n", conclusion)
